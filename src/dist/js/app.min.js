...
"use strict";function FileReadException(t){alert("Erro! Abra o console para saber mais."),this.message=t,this.name="FileReadException"}function PointCoordinateParseException(t){alert("Erro! Abra o console para saber mais."),this.message=t,this.name="PointCoordinateParseException"}function PointReferenceException(t){alert("Erro! Abra o console para saber mais."),this.message=t,this.name="PointReferenceException"}function PointSumException(t){alert("Erro! Abra o console para saber mais."),this.message=t,this.name="PointSumException"}function MatrixSizeException(t){alert("Erro! Abra o console para saber mais."),this.message=t,this.name="MatrixSizeException"}function MatrixMultiplicationException(t){alert("Erro! Abra o console para saber mais."),this.message=t,this.name="MatrixMultiplicationException"}function BadColorException(t){alert("Erro! Abra o console para saber mais."),this.message=t,this.name="BadColorException"}function eraseCanvas(){ctx.clearRect(0,0,canvasWidth,canvasHeight)}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function capitalize(t){return t[0].toUpperCase()+t.slice(1)}function getObjectName(t){return t=t.split(".")[0],capitalize(t)}function getDistance(t,e){var o=t.coordinates.map(function(t,o){return t-e.coordinates[o]}).reduce(function(t,e){return t+e*e},0);return Math.sqrt(o)}var scenarioObjects,scenarioCamera,scenarioLight,defaultColor={red:60,green:16,blue:218,alpha:255},drawPixel=function(t,e,o,r,i,n,a){var s=t.createImageData(1,1);s.data[0]=r,s.data[1]=i,s.data[2]=n,s.data[3]=a,t.putImageData(s,e,o)},drawTriangleBarycentricAlgorithm=function(t,e){for(var o=-1,r=canvasWidth+1,i=-1,n=canvasHeight+1,a=0;a<e.points.length;++a){var s=e.points[a];s.coordinates[0]>o&&(o=s.coordinates[0]),s.coordinates[0]<r&&(r=s.coordinates[0]),s.coordinates[1]>i&&(i=s.coordinates[1]),s.coordinates[1]<n&&(n=s.coordinates[1])}for(var c=n;c<=i;++c)for(var l=r;l<=o;++l){var u=new Point2D(l,c),d=getBarycentricCoordinates(e,u);isInside(d)&&drawPixel(t,l,c,defaultColor.red,defaultColor.green,defaultColor.blue,defaultColor.alpha)}},drawLine=function(t,e,o,r){for(var i=Math.min(e,o),n=Math.max(e,o),a=i;a<=n;++a)drawPixel(t,a,r,defaultColor.red,defaultColor.green,defaultColor.blue,defaultColor.alpha)},drawFlatBottomTriangle=function(t,e){var o=e.points,r=o[1].coordinates[0]-o[0].coordinates[0],i=o[1].coordinates[1]-o[0].coordinates[1],n=parseFloat(r/i);r=o[2].coordinates[0]-o[0].coordinates[0],i=o[2].coordinates[1]-o[0].coordinates[1];for(var a=parseFloat(r/i),s=parseFloat(o[0].coordinates[0]),c=parseFloat(o[0].coordinates[0]),l=o[0].coordinates[1];l<=o[1].coordinates[1];++l)drawLine(t,s,c,l),s+=n,c+=a},drawFlatTopTriangle=function(t,e){var o=e.points,r=o[2].coordinates[0]-o[0].coordinates[0],i=o[2].coordinates[1]-o[0].coordinates[1],n=parseFloat(r/i);r=o[2].coordinates[0]-o[1].coordinates[0],i=o[2].coordinates[1]-o[1].coordinates[1];for(var a=parseFloat(r/i),s=parseFloat(o[2].coordinates[0]),c=parseFloat(o[2].coordinates[0]),l=o[2].coordinates[1];l>=o[0].coordinates[1];--l)drawLine(t,s,c,l),s-=n,c-=a},drawTriangleScanLine=function(t,e){e.sortPointsByYX();var o=e.points;if(o[0].coordinates[1]==o[1].coordinates[1])drawFlatTopTriangle(t,e);else if(o[1].coordinates[1]==o[2].coordinates[1])drawFlatBottomTriangle(t,e);else{var r=o[1].coordinates[1]-o[0].coordinates[1],i=o[2].coordinates[1]-o[0].coordinates[1],n=parseFloat(r/i);n*=o[2].coordinates[0]-o[0].coordinates[0];var a=parseInt(o[0].coordinates[0]+n),s=o[1].coordinates[1],c=new Point2D(a,s),l=new Triangle2D(o[0],o[1],c),u=new Triangle2D(o[1],c,o[2]);drawFlatBottomTriangle(t,l),drawFlatTopTriangle(t,u)}},canvas=document.getElementById("main-canvas"),ctx=canvas.getContext("2d"),canvasWidth=canvas.width,canvasHeight=canvas.height,drawObject=function(t){for(var e=t.triangles2D,o=0;o<e.length;++o)drawTriangleScanLine(ctx,e[o])},storeObjectFileContent=function(t,e){var o=getObjectName(e),r=new Object3D(o),i=t.split("\n"),n=i[0].split(" "),a=parseInt(n[0]),s=(parseInt(n[1]),void 0);for(s=1;s<=a;++s){var c=i[s].split(" "),l=parseFloat(c[0]),u=parseFloat(c[1]),d=parseFloat(c[2]);if(isNaN(l)||isNaN(u)||isNaN(d)){throw new PointCoordinateParseException("Arquivo "+e+": Ponto "+s+" com coordenada inválida. Revise o arquivo enviado.")}var h=new Point(l,u,d),p=new Vector(-scenarioCamera.focus.coordinates[0],-scenarioCamera.focus.coordinates[1],-scenarioCamera.focus.coordinates[2]);(h=(h=PointOperations.addVector(h,p)).baseChange(scenarioCamera.transformMatrix)).id=s-1,h.normalVector=new Vector(0,0,0),r.points3D.push(h);var f=scenarioCamera.dist/scenarioCamera.hx*(h.coordinates[0]/h.coordinates[2]),m=scenarioCamera.dist/scenarioCamera.hy*(h.coordinates[1]/h.coordinates[2]);f=Math.floor((f+1)*(canvasWidth/2)),m=Math.floor(canvasHeight/2*(1-m));var v=new Point2D(f,m);r.points2D.push(v)}for(;s<i.length;++s){var g=i[s].split(" ");if(g.length<3)0;else{var C=parseInt(g[0]),w=parseInt(g[1]),x=parseInt(g[2]);if(isNaN(C)||isNaN(w)||isNaN(x)||C<1||C>r.points3D.length||w<1||w>r.points3D.length||x<1||w>r.points3D.length){throw new PointReferenceException("Arquivo "+e+": Triângulo "+s+" com referência para ponto inválida. Revise o arquivo enviado.")}var b=new Triangle3D(r.points3D[C-1],r.points3D[w-1],r.points3D[x-1]);r.triangles3D.push(b);var y=b.normalVector;r.points3D[C-1].normalVector=VectorOperations.add(r.points3D[C-1].normalVector,y),r.points3D[w-1].normalVector=VectorOperations.add(r.points3D[w-1].normalVector,y),r.points3D[x-1].normalVector=VectorOperations.add(r.points3D[x-1].normalVector,y);var V=new Triangle2D(r.points2D[C-1],r.points2D[w-1],r.points2D[x-1]);r.triangles2D.push(V)}}for(var P=0;P<r.points3D.length;++P){var D=r.points3D[P];D.normalVector=D.normalVector.getNormalizedVector()}scenarioObjects.push(r),drawObject(r)},storeCameraFileContent=function(t,e){for(var o=t.split("\n"),r=[],i=function(t){var i=o[t].split(" ").map(function(o){var r=parseFloat(o);if(isNaN(r)){throw new PointCoordinateParseException("Arquivo "+e+": Ponto "+t+" com coordenada inválida. Revise o arquivo enviado.")}return r});r.push(i)},n=0;n<4;++n)i(n);var a=new Point(r[0][0],r[0][1],r[0][2]),s=new Vector(r[1][0],r[1][1],r[1][2]),c=new Vector(r[2][0],r[2][1],r[2][2]),l=r[3][0],u=r[3][1],d=r[3][2];scenarioCamera=new Camera(a,s,c,l,u,d)},storeLightFileContent=function(t,e){for(var o=t.split("\n"),r=[],i=0;i<8;++i){var n=o[i].split(" ");r.push(n)}var a=new Point(parseFloat(r[0][0]),parseFloat(r[0][1]),parseFloat(r[0][2])),s=new Vector(-scenarioCamera.focus.coordinates[0],-scenarioCamera.focus.coordinates[1],-scenarioCamera.focus.coordinates[2]);a=(a=PointOperations.addVector(a,s)).baseChange(scenarioCamera.transformMatrix);var c=parseFloat(r[1][0]),l=[parseInt(r[2][0]),parseInt(r[2][1]),parseInt(r[2][2])],u=parseFloat(r[3][0]),d=[parseFloat(r[4][0]),parseFloat(r[4][1]),parseFloat(r[4][2])],h=parseFloat(r[5][0]),p=[parseInt(r[6][0]),parseInt(r[6][1]),parseInt(r[6][2])],f=parseFloat(r[7][0]);scenarioLight=new Illumination(a,c,l,u,d,h,p,f)},loadFiles=function(t,e){for(var o=document.getElementById(t).files,r=function(t){var r=o[t],i=new FileReader;i.onload=function(t){var o=t.target.result;e(o,r.name)},i.onerror=function(t){throw new FileReadException("Erro ao carregar arquivo "+r.name+". Selecione arquivos de texto!")},i.readAsText(r)},i=0;i<o.length;++i)r(i)},validateFilesInputs=function(){var t=document.getElementById("file-input-field"),e=document.getElementById("camera-input-field"),o=document.getElementById("light-input-field"),r=t.files.length,i=e.files.length,n=o.files.length;return 1==i&&r>0&&n>0},runApp=function(){validateFilesInputs()?(eraseCanvas(),scenarioObjects=[],loadFiles("camera-input-field",storeCameraFileContent),loadFiles("file-input-field",storeObjectFileContent),loadFiles("light-input-field",storeLightFileContent)):Materialize.toast("Selecione uma câmera, uma iluminação e um ou mais objetos!",4e3)},_createClass=function(){function t(t,e){for(var o=0;o<e.length;o++){var r=e[o];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}return function(e,o,r){return o&&t(e.prototype,o),r&&t(e,r),e}}(),EPS=1e-10;Array.prototype.back=function(){return this[this.length-1]};var Triple=function(){function t(e,o,r,i){_classCallCheck(this,t),this.coordinates=[e,o,r],this.isPoint=i}return _createClass(t,[{key:"multiply",value:function(t){var e=this;this.coordinates.forEach(function(o,r){e.coordinates[r]=o*t})}},{key:"toArray",value:function(t){var e=this.coordinates.map(function(t){return t});return t&&e.push(this.isPoint),e}},{key:"baseChange",value:function(t){var e=new Matrix({rows:4,columns:1,matrix:[[this.coordinates[0]],[this.coordinates[1]],[this.coordinates[2]],[this.isPoint]],addDimension:!1}),o=MatrixOperations.multiply(t,e);return this.isPoint?new Point(o.matrix[0][0],o.matrix[1][0],o.matrix[2][0]):new Vector(o.matrix[0][0],o.matrix[1][0],o.matrix[2][0])}}]),t}(),Point=function(t){function e(t,o,r){return _classCallCheck(this,e),_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,o,r,1))}return _inherits(e,Triple),e}(),Point2D=function t(e,o){_classCallCheck(this,t),this.coordinates=[e,o]},Vector=function(t){function e(t,o,r){return _classCallCheck(this,e),_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,o,r,0))}return _inherits(e,Triple),_createClass(e,[{key:"getNorm",value:function(){return Math.sqrt(this.coordinates.reduce(function(t,e){return t+e*e},0))}},{key:"getNormalizedVector",value:function(){var t=this.getNorm(),o=this.coordinates.map(function(e){return e/t});return new e(o[0],o[1],o[2])}}]),e}(),Triangle3D=function(){function t(e,o,r){_classCallCheck(this,t),this.points=[e,o,r],this.calculateNormalVector()}return _createClass(t,[{key:"getArea",value:function(){return this.normalVector.getNorm()/2}},{key:"calculateNormalVector",value:function(){var t=PointOperations.subtract(this.points[2],this.points[0]),e=PointOperations.subtract(this.points[1],this.points[0]);this.normalVector=VectorOperations.vectorialProduct(t,e).getNormalizedVector()}}]),t}(),Triangle2D=function(){function t(e,o,r){_classCallCheck(this,t),this.points=[e,o,r]}return _createClass(t,[{key:"getArea",value:function(){var t=getDistance(this.points[0],this.points[1]),e=getDistance(this.points[0],this.points[2]),o=getDistance(this.points[1],this.points[2]),r=(t+e+o)/2;return Math.sqrt(r*(r-t)*(r-e)*(r-o))}},{key:"sortPointsByYX",value:function(){this.points.sort(function(t,e){return t.coordinates[1]<e.coordinates[1]?-1:t.coordinates[1]>e.coordinates[1]?1:t.coordinates[0]<e.coordinates[0]?-1:1})}}]),t}(),PointOperations=function(){function t(){_classCallCheck(this,t)}return _createClass(t,null,[{key:"subtract",value:function(t,e){var o=t.coordinates.map(function(t,o){return t-e.coordinates[o]});return new Vector(o[0],o[1],o[2])}},{key:"addVector",value:function(t,e){if(t.isPoint&&e.isPoint){throw new PointSumException("Impossível adicionar dois pontos! Use soma baricêntrica.")}var o=t.coordinates.map(function(t,o){return t+e.coordinates[o]});return new Point(o[0],o[1],o[2])}}]),t}(),VectorOperations=function(){function t(){_classCallCheck(this,t)}return _createClass(t,null,[{key:"add",value:function(t,e){var o=t.coordinates.map(function(t,o){return t+e.coordinates[o]});return new Vector(o[0],o[1],o[2])}},{key:"subtract",value:function(t,e){var o=t.coordinates.map(function(t,o){return t-e.coordinates[o]});return new Vector(o[0],o[1],o[2])}},{key:"scalarMultiplication",value:function(t,e){var o=new Vector(t.coordinates[0],t.coordinates[1],t.coordinates[2]);return o.coordinates.forEach(function(t,r){o.coordinates[r]=t*e}),o}},{key:"addPoint",value:function(t,e){var o=t.coordinates.map(function(t,o){return t+e.coordinates[o]});return new Point(o[0],o[1],o[2])}},{key:"vectorProjection",value:function(t,e){var o=this.scalarProduct(t,e),r=this.scalarProduct(e,e);return this.scalarMultiplication(e,o/r)}},{key:"scalarProduct",value:function(t,e){return t.coordinates.reduce(function(t,o,r){return t+o*e.coordinates[r]},0)}},{key:"vectorialProduct",value:function(t,e){var o=t.coordinates,r=e.coordinates;return new Vector(o[1]*r[2]-o[2]*r[1],o[2]*r[0]-o[0]*r[2],o[0]*r[1]-o[1]*r[0])}}]),t}(),Object3D=function t(e){_classCallCheck(this,t),this.objectName=e,this.triangles3D=[],this.triangles2D=[],this.points3D=[],this.points2D=[]},Camera=function(){function t(e,o,r,i,n,a){_classCallCheck(this,t),this.focus=e,this.directionVector=o,this.upVector=r,this.dist=i,this.hx=n,this.hy=a,this.initializeCamera()}return _createClass(t,[{key:"initializeCamera",value:function(){this.ortogonalize(),this.directionVector=this.directionVector.getNormalizedVector(),this.upVector=this.upVector.getNormalizedVector(),this.initializeThirdVector(),this.initializeCameraMatrix()}},{key:"ortogonalize",value:function(){var t=VectorOperations.vectorProjection(this.upVector,this.directionVector);this.upVector=VectorOperations.subtract(this.upVector,t)}},{key:"initializeThirdVector",value:function(){this.thirdVector=VectorOperations.vectorialProduct(this.directionVector,this.upVector)}},{key:"initializeCameraMatrix",value:function(){this.transformMatrix=new Matrix({rows:3,columns:3,matrix:[this.thirdVector.toArray(!1),this.upVector.toArray(!1),this.directionVector.toArray(!1)],extraDimension:!0})}}]),t}(),Color=function(){function t(e,o,r){_classCallCheck(this,t),this.rgb={red:e,blue:o,green:r},validateColor()}return _createClass(t,[{key:"validateColor",value:function(){if(this.rgb.red<0||this.rgb.red>255||this.rgb.green<0||this.rgb.green>255||this.rgb.blue<0||this.rgb.blue>255){throw new BadColorException("Color componentes out of range! RGB = (\n                        "+this.rgb.red+","+this.rgb.green+","+this.rgb.blue+")")}if(isNaN(this.rgb.red))throw new BadColorException("RGB invalid red component!");if(isNaN(this.rgb.green))throw new BadColorException("RGB invalid green component!");if(isNaN(this.rgb.blue))throw new BadColorException("RGB invalid blue component!")}}]),t}(),Illumination=function t(e,o,r,i,n,a,s,c){_classCallCheck(this,t),this.focus=e,this.ambRefl=o,this.ambColor=r,this.difConstant=i,this.difVector=n,this.spec=a,this.sourceColor=s,this.rugosity=c},Matrix=function(){function t(e){_classCallCheck(this,t),this.rows=e.rows,this.columns=e.columns,e.matrix?(this.matrix=e.matrix,this.validate()):this.initializeMatrix(),e.extraDimension&&this.addExtraDimension()}return _createClass(t,[{key:"addExtraDimension",value:function(){for(var t=0;t<this.rows;++t)this.matrix[t].push(0);var e=new Array(this.columns);e.fill(0),e.push(1),this.matrix.push(e),++this.rows,++this.columns}},{key:"initializeMatrix",value:function(){this.matrix=new Array(this.rows);for(var t=0;t<this.rows;++t)this.matrix[t]=new Array(this.columns)}},{key:"validate",value:function(){for(var t=0;t<this.matrix.length-1;++t)if(this.matrix[t].length!=this.matrix[t+1].length)throw new MatrixSizeException("Matrizes com linhas com diferente número de colunas.")}}]),t}(),MatrixOperations=function(){function t(){_classCallCheck(this,t)}return _createClass(t,null,[{key:"multiply",value:function(e,o){if(e.columns!=o.rows){throw new MatrixMultiplicationException("Can't multiply matrix with "+e.columns+" columns\n                            by matrix with "+o.rows+" rows!")}for(var r=t.getNewMatrix(e.rows,o.columns),i=0;i<r.rows;++i)for(var n=0;n<r.columns;++n)for(var a=0;a<e.columns;++a)r.matrix[i][n]+=e.matrix[i][a]*o.matrix[a][n];return r}},{key:"getNewMatrix",value:function(t,e){for(var o=Array(t),r=0;r<o.length;++r)o[r]=new Array(e),o[r].fill(0);return new Matrix({rows:t,columns:e,matrix:o})}}]),t}(),isInside=function(t){for(var e=0;e<t.length;++e){var o=t[e];if(o<0||o>1)return!1}return!0},getBarycentricCoordinates=function(t,e){var o=t.getArea(),r=new Triangle2D(t.points[0],t.points[1],e),i=new Triangle2D(t.points[0],t.points[2],e);return[new Triangle2D(t.points[1],t.points[2],e).getArea()/o,i.getArea()/o,r.getArea()/o]};